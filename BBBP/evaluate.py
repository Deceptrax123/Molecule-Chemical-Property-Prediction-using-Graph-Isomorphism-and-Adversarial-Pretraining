import torch
from BBBP.bbbp_dataset import BBBPDataset
...
if __name__ == '__main__':
    ...
    test_set = BBBPDataset(fold_key='Fold8', root=os.getenv(
    ...
    model.load_state_dict(torch.load("BBBP/weights/run_1/model_500.pth"))
